...
<main class="flex flex-col gap-7 m-9 max-w-5xl lg:mx-auto">
  <h1 class="font-light text-3xl">Ayurveda | Dosha Prakriti Quiz</h1>

  <h3 class="font-light">
    Please answer the questions as objectively as you can. Try to answer with the idea in mind that
    you are assessing yourself based on general tendencies that you have held since around the age
    of 17 years until now. Also, base your answers on people with your genetic/cultural background.
    If you have trouble with some questions, ask someone who has known you for a while for an
    objective answer.
  </h3>
